-- VHDL Entity alien_game_lib.c7_t1_integration.symbol
--
-- Created:
--          by - Minh.UNKNOWN (DESKTOP-R6EVFEE)
--          at - 23:31:38 12/ 6/2020
--
...
END c7_t1_integration ;

--
-- VHDL Architecture alien_game_lib.c7_t1_integration.struct
--
-- Created:
--          by - Minh.UNKNOWN (DESKTOP-R6EVFEE)
--          at - 23:31:38 12/ 6/2020
...
ARCHITECTURE struct OF c7_t1_integration IS
   ...
   FOR ALL : reg_bank USE ENTITY pre_made.reg_bank;
   FOR ALL : serial_led_cannon USE ENTITY pre_made.serial_led_cannon;
   FOR ALL : v2_gamma USE ENTITY pre_made.v2_gamma;
   FOR ALL : v2_rst USE ENTITY pre_made.v2_rst;
   FOR ALL : v2_serial_tx USE ENTITY pre_made.v2_serial_tx;
   -- pragma synthesis_on
...
BEGIN
   ...
   -- ModuleWare code(v1.12) for instance 'constant_0' of 'constval'
   lat_g <= '1';
