-- VHDL Entity alien_game_lib.c2_t2_bin_to_onehot.symbol
--
-- Created:
--          by - mmledo.mmledo (linux-desktop7.tuni.fi)
--          at - 09:36:05 09/30/20
--
...
END c2_t2_bin_to_onehot ;

--
-- VHDL Architecture alien_game_lib.c2_t2_bin_to_onehot.tbl
--
-- Created:
--          by - fmthng.fmthng (linux-desktop1.tuni.fi)
--          at - 12:04:48 09/30/20
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2019.3 (Build 4)
--
LIBRARY ieee;
USE ieee.std_logic_1164.all;
USE ieee.std_logic_arith.all;
ARCHITECTURE tbl OF c2_t2_bin_to_onehot IS
