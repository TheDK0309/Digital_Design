-- VHDL Entity alien_game_lib.c7_t2_final_assembly.symbol
--
-- Created:
--          by - Minh.UNKNOWN (DESKTOP-R6EVFEE)
--          at - 21:19:28 12/ 6/2020
--
...
ENTITY c7_t2_final_assembly IS
   PORT( 
...
END c7_t2_final_assembly ;

--
-- VHDL Architecture alien_game_lib.c7_t2_final_assembly.struct
--
-- Created:
--          by - Minh.UNKNOWN (DESKTOP-R6EVFEE)
--          at - 10:31:29 12/ 7/2020
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2019.3 (Build 4)
--
LIBRARY ieee;
...
ARCHITECTURE struct OF c7_t2_final_assembly IS
   ...
   SIGNAL alien_health_out : std_logic_vector(1 DOWNTO 0);
...
BEGIN
   ...
   U_1 : c2_t6_basic_alien
      PORT MAP (
         ...
         alien_health_out => alien_health_out
      );
   ...
   U_3 : c5_t2_write_sequencer
      PORT MAP (
         alien_defeated  => alien_defeated,
         alien_health_in => alien_health_out,
         clk             => clk,
         rst_n           => rst_n,
         write_ready     => w_rdy,
         enable          => enable,
